...
import kotlinx.android.synthetic.main.fragment_new_event_step_3.*
import kotlinx.android.synthetic.main.fragment_new_event_step_3.view.*

/**
 * Created by evanfang102 on 2017/7/27.
 */

class NewEventStep3Fragment : Fragment(), EventTypeWidget.Companion.OnSelectionChanged {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        rootView = inflater!!.inflate(R.layout.fragment_new_event_step_3, container, false)
        return rootView
    }
